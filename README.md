...
- `./src/app/api:` É o nosso 'back-end' interno do next, respondendo à métodos HTTP.
    - sendStudentsEmail: Rota de POST destinada a receber os dados do usuário que vieram atráves de Plans/QuestionnaireModal e enviar um e-mail de confirmação de novo aluno
